 ...
 * @h2.resource
 */
public class H2Server extends Tool implements Runnable, ShutdownHandler {

    private final Service service;
    private H2Server web, tcp, pg;
     ...
     * @return the server
     */
    public static H2Server createWebServer(String... args) throws SQLException {
        WebServer service = new WebServer();
        H2Server server = new H2Server(service, args);
     ...
     * @return the server
     */
    public static H2Server createTcpServer(String... args) throws SQLException {
     ...
     * @return the server
     */
    public static H2Server createPgServer(String... args) throws SQLException {
        return new H2Server(new PgServer(), args);
    }
     ...
     */
    public H2Server start() throws SQLException {
        try {
            started = true;
            service.start();
    ...
    public static void startWebServer(Connection conn) throws SQLException {
        ...
        H2Server web = new H2Server(webServer, new String[] { "-webPort", "0" });
        web.start();
